...
#ifdef NSPIRE
	/* Skip INI and PRINCE.EXE loading on Nspire.
	 * The packed custom_options_type struct has word fields at unaligned offsets.
	 * The INI parser dereferences word* pointers to those fields, causing data abort.
	 * Default values are fine for Nspire. */
	return;
#endif
